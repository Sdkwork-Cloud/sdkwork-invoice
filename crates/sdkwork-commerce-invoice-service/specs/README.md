...
This directory is the local standards index for `sdkwork_commerce_invoice_service`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-commerce-invoice-service` |
| Type | `rust-crate` |
| Root | `sdkwork-commerce/crates/sdkwork-commerce-invoice-service` |
| Domain | `commerce` |
| Capability | `commerce` |
| Languages | `rust` |
| Status | `stable` |
